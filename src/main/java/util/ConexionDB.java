...
public class ConexionDB {
    ...
    private static final String URL = "jdbc:mysql://localhost:3307/integrador_cac?useSSL=false&requireSSL=false";
    private static final String USER = "root";
    private static final String PASSWORD = "Ottosalchi456$%&";
